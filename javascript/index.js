...
//
mashedPotatoes.push("Mashed Potatoes are done!");
...
broccoli.push("Broccoli is done!");
...
async function makeBroccoli() {
  ...
  const instruction7 = await obtainInstruction("broccoli", 7);
